...
import json
import httpx
from taskA import A1, A2, A3, A4, A5, A6, A7, A8, A9, A10
from taskB import B3, B5, B6, B7, B9
...
open_api_chat = "https://aiproxy.sanand.workers.dev/openai/v1/chat/completions"
...
"""
    ...
    response = requests(url=url, headers=headers, json=data)
    return response.json()
# arguments = json.loads(response.json()['choices'][0]['message']['tool_calls'][0]['arguments']
